...
export const trips: Trip[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    hotels: [
      { property: 'Hyatt Bishkek', location: 'Bishkek, Kyrgyzstan', checkIn: '2026-08-02', checkOut: '2026-08-03', program: 'Hyatt', status: 'booked', notes: 'Aug 2 arrival night. Flight lands 4:30am — earliest official check-in 8:00am. Contact concierge in advance to request early access. Trek operator picks up from hotel on Aug 3.' },
      { property: 'Yurt stays (Gusary Stables)', location: 'Song-Kol Lake region, Kyrgyzstan', checkIn: '2026-08-03', checkOut: '2026-08-08', status: 'booked', notes: 'Aug 3–8, included with Gusary Stables trek. 5 nights in yurt camps.' },
      { property: 'TBD — Almaty', location: 'Almaty, Kazakhstan', checkIn: '2026-08-08', checkOut: '2026-08-12', status: 'not_booked', notes: 'Post-trek recovery, 4 nights (Aug 8–12). Check-in Aug 8 evening after transfer from trek.' },
    ],
    actionItems: [
    ...
    itinerary: [
      ...
      { date: 'August 7', label: 'Horse Trek — Day 4', description: 'Continued riding. Final full day in the saddle. Yurt camp overnight.', type: 'activity' },
      { date: 'August 8', label: 'Trek Complete — Transfer to Almaty', description: 'Final morning ride. Descend from high passes. Trek done. Vehicle transfer to Almaty (~6–7 hrs). Hot shower and real bed.', type: 'activity' },
    ...
    costs: [
      ...
      // ─── Lodging ───
      { category: 'hotel', description: 'Hyatt Bishkek (1 nt, Aug 2–3)', program: 'Hyatt', note: 'Booked. Arrive 4:30am — earliest check-in 8am. Concierge contacted for early access. Trek pickup from hotel lobby Aug 3.' },
