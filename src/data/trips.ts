...
export const trips: Trip[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    flights: [
      { segment: 0.5, date: '2026-07-25', route: 'LAX → LHR', time: '6:10pm → 12:45pm +1', airline: 'American Airlines (AA136)', cabin: 'Business (J)', confirmation: 'OMKZTH', status: 'booked', notes: 'JANELLE ONLY — pre-trip positioning to London. 77K AAdvantage + $5.60, seat 9A. Departs LAX (not Seattle) — confirm Janelle\'s SEA→LAX hop or that she\'s already in LA. ~6 days in London before the Aug 1 LHR→Bishkek leg.' },
    ...
    actionItems: [
      ...
      { text: 'Confirm Janelle\'s SEA → LAX hop before AA136 (her London flight departs LAX, not Seattle, on Jul 25)', urgent: true },
    ...
    itinerary: [
      { date: 'July 25–26', label: 'Janelle Flies to London', description: 'Janelle: LAX 6:10pm → LHR 12:45pm +1 on American AA136 Business (conf: OMKZTH, seat 9A). Pre-trip in London ~6 days before continuing to Bishkek on Aug 1.', type: 'travel' },
    ...
    costs: [
      ...
      { category: 'flight', description: 'LAX → LHR on American AA136 Business (Jul 25, JANELLE only)', pnr: 'OMKZTH', seat: '9A', points: 77000, program: 'AAdvantage', cashUsd: 5.60, note: 'Janelle\'s pre-trip positioning to London. 77K AAdvantage + $5.60. Departs LAX — confirm SEA→LAX hop.' },
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    flights: [
      ...
      { segment: 4, date: '2026-11-30', route: 'SEZ → NBO (Mahé → Nairobi)', time: '~05:25 → ~07:35 (early AM)', airline: 'Kenya Airways', cabin: 'Business', status: 'needs_action', notes: '~3h10 direct. Nov 30 only has the early-morning departure — and Platte\'s seaplane can\'t fly pre-dawn, so you overnight on Mahé (Nov 29) and catch this flight. Upside: lands Nairobi mid-morning, making the Tsavo connection easy with a full first-afternoon game drive.' },
      { segment: 5, date: '2026-11-30', route: 'NBO (Wilson) → Finch Hattons airstrip (Tsavo West)', time: 'late morning / midday', airline: 'SafariLink/AirKenya scheduled OR private charter', cabin: 'Light aircraft', status: 'needs_action', notes: '~1h, lands 10 min from camp. KQ lands at JKIA; safari flights leave from Wilson — 30–60 min road transfer. Morning KQ arrival makes a same-day Tsavo connection comfortable; charter as backup if the scheduled slot doesn\'t line up.' },
      // ─── Kenya → Home (evening departure, keeps full last game-drive morning) ───
      { segment: 6, date: '2026-12-03', route: 'Finch Hattons airstrip → NBO (Wilson)', time: 'midday', airline: 'SafariLink/AirKenya OR charter', cabin: 'Light aircraft', status: 'needs_action', notes: 'After dawn game drive + checkout. Transfer Wilson→JKIA for the evening international departure.' },
      { segment: 7, date: '2026-12-03', route: 'NBO → SEA (evening departure)', airline: 'Qatar via DOH / Turkish via IST / KLM-Delta via AMS', cabin: 'Business', status: 'needs_action', notes: 'Evening Dec 3 departure → arrive Seattle Dec 4. Compare Qatar Qsuites (Avios), Turkish (Miles&Smiles/Aeroplan), and KLM/Delta (Virgin Flying Club) for business award space before committing points.' },
    ],
    hotels: [
      { property: 'Waldorf Astoria Seychelles Platte Island', location: 'Platte Island, Outer Seychelles', checkIn: '2026-11-25', checkOut: '2026-11-29', program: 'Hilton Honors', status: 'not_booked', notes: '4 nights on ~480K Hilton points (Terry has the points; availability confirmed). Cash equivalent ~$6,000–12,000. PADI 5-Star Dive Resort on-site. Seaplane straight from Mahé on arrival; check out Nov 29 afternoon for the Mahé pre-position night.' },
      { property: 'Mahé Hilton (pre-position night)', location: 'Mahé, Seychelles', checkIn: '2026-11-29', checkOut: '2026-11-30', program: 'Hilton Honors', status: 'not_booked', notes: 'One night near the airport for the early-morning KQ to Nairobi. Use Hilton points: DoubleTree Allamanda (south Mahé, closest to airport) or the plusher Mango House LXR / Northolme. Platte\'s seaplane can\'t make a pre-dawn departure, so this overnight is required — not a wasted day (enjoy a Mahé dinner + early night).' },
    ...
    actionItems: [
      { text: 'CONFIRM Kenya Airways flies SEZ→NBO on Mon Nov 30 (midday). If not, shift to Sun Nov 29 (4 Platte nts) or Tue Dec 1 (6 Platte nts) — this date drives everything.', urgent: true },
      { text: 'Book SEZ → NBO Kenya Airways for the travel day (2 pax, business)', urgent: true },
      { text: 'Book Waldorf Astoria Platte Island Nov 25–30 (5 nts, ~600K Hilton points)', urgent: true },
      { text: 'Book Finch Hattons Nov 30 – Dec 3 (3 nts, ~300K Virgin points) — verify the exact loyalty currency', urgent: true },
      { text: 'Arrange Finch Hattons air via the camp travel desk: Wilson→camp on Nov 30 + camp→Wilson on Dec 3. Book a PRIVATE CHARTER timed to the KQ arrival to guarantee no Nairobi overnight.', urgent: true },
      { text: 'Book NBO → SEA evening departure Dec 3 (compare Qatar Qsuites / Turkish / KLM-Virgin business award)', urgent: true },
      { text: 'Book Janelle\'s onward IST→ leg (IST→SEZ for Option A, or IST→NBO for Option B) to match her SEA→IST (TLBR8E)', urgent: true },
      { text: 'Verify Janelle is on TB6NH6 (IST→SEZ) or holds her own PNR', urgent: true },
      { text: 'Confirm same-day connection timing on Nov 30: KQ NBO arrival vs Tsavo flight, plus the JKIA↔Wilson 30–60 min road transfer', urgent: true },
    ...
    intel: [
      ...
      { title: 'Connecting through Nairobi without losing a day', content: 'The one logistics puzzle is Nov 30: Platte → Mahé → Nairobi → Tsavo, all in a day. Kenya Airways flies SEZ→NBO nonstop (~3h10) but flexes between ~2x/week and daily by season — so first confirm it operates that Monday. Aim for a late-morning/midday KQ departure (the early red-eye is unreachable after a daylight Platte seaplane). In Nairobi, KQ lands at JKIA while safari aircraft leave from Wilson — a 30–60 min road transfer, so allow ~2.5–3h. To guarantee no overnight, book a private charter Wilson→Finch Hattons timed to the KQ arrival rather than relying on the scheduled afternoon slot. On Dec 3, fly out of Nairobi in the evening so the full last game-drive morning isn\'t wasted.' },
    ...
    awardTips: [
      ...
      { program: 'Hilton Honors', route: 'Waldorf Astoria Platte (5 nts)', cost: '~600K Hilton points', note: 'Cash rates $1,500–3,000/nt → ~$7,500–15,000 cash equivalent for 5 nts. Outstanding points value; availability confirmed.' },
      ...
      { program: 'Qatar Avios / Turkish / Virgin', route: 'NBO→SEA return (Dec 3)', cost: 'TBD', note: 'Compare Qatar Qsuites via DOH (Avios), Turkish via IST (Miles&Smiles/Aeroplan), and KLM/Delta via AMS (Virgin Flying Club) for evening business award space.' },
    ],
    itinerary: [
      ...
      { date: 'Nov 29', label: 'Platte — Final Reef Day', description: 'Last dives or a slow snorkel morning on the house reef. Relax and pack — early travel day tomorrow. Sunset cocktails on the deck.', type: 'rest' },
      { date: 'Nov 30', label: 'Seychelles → Kenya (Platte → Tsavo, same day)', description: 'Check out Waldorf Astoria Platte. Morning seaplane Platte → Mahé. Midday Kenya Airways SEZ → NBO (~3h10). Road transfer JKIA → Wilson (~45 min). Afternoon light aircraft / private charter Wilson → Finch Hattons airstrip (~1h). Evening game drive on arrival. Check in to Finch Hattons. NO Nairobi overnight.', type: 'travel' },
      ...
      { date: 'Dec 3', label: 'Fly Home (evening departure)', description: 'Dawn game drive + breakfast, then check out. Midday light aircraft Finch Hattons → Wilson. Transfer Wilson → JKIA. Evening NBO → SEA departure (Qatar via DOH / Turkish via IST / KLM via AMS). Overnight flight.', type: 'travel' },
      { date: 'Dec 4', label: 'Arrive Seattle', description: 'Land SEA after the overnight connection home. Trip complete — 11 days, reef to bush.', type: 'travel' },
    ],
    costs: [
      // ─── Flights — Booked ───
      ...
      { category: 'flight', description: 'NBO → SEA return (Dec 3 evening, 2 pax, routing TBD)', note: 'Not yet booked. Compare Qatar Qsuites via DOH (Avios), Turkish via IST (Miles&Smiles/Aeroplan), KLM/Delta via AMS (Virgin Flying Club). Cash $1,800–3,500/pp typical for Business.' },
      // ─── Lodging ───
      { category: 'hotel', description: 'Waldorf Astoria Platte Island (5 nts, Nov 25–30)', program: 'Hilton Honors', points: 600000, note: 'Not yet booked. ~600K Hilton points, availability confirmed. Cash equivalent ~$7,500–15,000 — outstanding value.' },
      ...
      // ─── Transfers ───
      { category: 'transfer', description: 'Mahé → Platte seaplane/boat (2 pax, one-way in + out)', cashUsd: 1500, note: 'Resort arranges. ~$500–1,000/pp RT typical for Outer Islands transfer.' },
      ...
      // ─── Activities ───
      { category: 'activity', description: 'Diving at Platte (~8–10 dives, 2 pax)', cashUsd: 2000, note: '$80–120/dive × 8–10 dives × 2 pax over 5 nights. Booked through Big Blue Divers or Blue Safari Seychelles on-site.' },
