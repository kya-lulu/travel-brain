...
export const trips: Trip[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    flights: [
      ...
      { segment: 2, date: '2026-12-26', route: 'SIN → CMB', time: '9:40 AM → 11:00 AM', airline: 'SriLankan Airlines (UL 0307)', aircraft: 'Airbus A320', cabin: 'Business', confirmation: 'XRDPGP', status: 'booked', notes: 'SIN Terminal 3. 3h 50m. Booked via British Airways Executive Club (XXXX1363), $238.60 fees. Tickets 125-2236269655 + 125-2236269656. Note: previous Dec 28 booking (TANOAL/BHZ9KV, 80K AAdvantage) may need to be cancelled.' },
