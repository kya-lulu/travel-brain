...
export const trips: Trip[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    flights: [
      ...
      { segment: 4, date: '2026-11-30', route: 'SEZ → NBO (Mahé → Nairobi)', time: 'Build 1 early-AM / Build 2 13:45→15:55', airline: 'Kenya Airways', cabin: 'Business', status: 'needs_action', notes: 'TWO BUILDS (pick at booking). BUILD 1: early-morning KQ Nov 30 after a Mahé pre-position night — clean, but a ~4:30am wakeup; lands NBO ~07:35 → camp same day. BUILD 2: 11:15 IDC Platte→Mahé (arr 12:10) Nov 29 + KQ 13:45→NBO 15:55 (tight ~1h35 self-connect), then a Nairobi night → camp morning Nov 30 (no pre-dawn wakeup). Both = 4 Platte nts + one transit night, camp from Nov 30. Re-confirm KQ operating day/time.' },
      { segment: 5, date: '2026-11-30', route: 'NBO (Wilson) → Finch Hattons airstrip (Tsavo West)', time: 'daytime', airline: 'SafariLink/AirKenya scheduled OR private charter', cabin: 'Light aircraft', status: 'needs_action', notes: '~1h, lands 10 min from camp. KQ lands at JKIA; safari flights leave from Wilson — 30–60 min road transfer. Daylight-only airstrip. Build 1 = afternoon arrival into camp; Build 2 = morning flight from a Nairobi overnight. Charter (~$1.5–2.5k) is the flexible backup.' },
    ...
    hotels: [
      ...
      { property: 'Transit night — Mahé (Build 1) OR Nairobi (Build 2)', location: 'Mahé or Nairobi', checkIn: '2026-11-29', checkOut: '2026-11-30', program: 'Hilton Honors / cash', status: 'not_booked', notes: 'ONE transit night on the Seychelles→Kenya hop. BUILD 1: Mahé Hilton on points (DoubleTree Allamanda near the airport / Mango House LXR / Northolme) before the early-morning KQ Nov 30. BUILD 2: a Nairobi hotel (after the 13:45 KQ lands 15:55) before the morning camp flight Nov 30. Either way, one night — Mahé is nicer; Nairobi avoids the ~4:30am wakeup.' },
    ...
    intel: [
      ...
      { title: 'Seychelles → Kenya: the one transit night', content: 'You can\'t reach Finch Hattons the same day you leave Platte — the camp airstrip is daylight-only and Nairobi connections don\'t line up for it. So there is one transit night, and two builds. BUILD 1: 13:45 Platte→Mahé on Nov 29, overnight at a Mahé Hilton, early-morning KQ to Nairobi Nov 30 (~07:35), camp by afternoon — clean but a ~4:30am wakeup. BUILD 2: 11:15 Platte→Mahé on Nov 29 + the 13:45 KQ to Nairobi (tight ~1h35 self-connect; Mahé terminals are a 2-min walk), overnight in Nairobi, camp the morning of Nov 30 — no pre-dawn wakeup but connection risk on a weather-prone Platte flight. Both land Finch night 1 on Nov 30 with 3 safari nights. (We ruled out the reverse order — Kenya first — because the twice-weekly NBO→Mahé red-eye plus the daylight-only Platte flight stacks up to 1–2 dead Nairobi nights.)' },
    ...
    itinerary: [
      ...
      { date: 'Nov 29', label: 'Platte → Mahé (transit night)', description: 'Final Platte morning (last dive/snorkel), then the 13:45 IDC flight → Mahé 14:05. BUILD 1: overnight at a Mahé Hilton, pre-positioning for the early KQ. [BUILD 2 alt: instead take the 11:15 IDC flight → connect to the 13:45 Kenya Airways to Nairobi (tight ~1h35), and overnight in Nairobi.]', type: 'travel' },
      { date: 'Nov 30', label: 'Seychelles → Kenya (to Tsavo)', description: 'BUILD 1: early-morning Kenya Airways Mahé → Nairobi (~07:35). Road JKIA → Wilson, light aircraft to Finch Hattons airstrip (~1h). Afternoon game drive. [BUILD 2: morning camp flight from the Nairobi overnight.] Check in to Finch Hattons. Either way, Finch night 1 = Nov 30.', type: 'travel' },
