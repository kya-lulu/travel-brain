...
export const trips: Trip[] = [
  ...
  // ═══════════════════════════════════════════════════════
  {
    ...
    flights: [
      ...
      { segment: 2.5, date: '2026-08-08', route: 'BSZ → ALA', airline: 'Air Astana', cabin: 'Economy', status: 'booked', notes: 'Bishkek → Almaty. Booked via Turkish Miles&Smiles (24K points transfer). Air Astana (Kazakhstani airline).' },
    ...
    itinerary: [
      ...
      { date: 'August 8', label: 'Fly Bishkek → Almaty', description: 'Fly BSZ → ALA on Air Astana (24K Turkish Miles&Smiles). Check into Almaty hotel. Begin recovery.', type: 'travel' },
    ...
    costs: [
      ...
      { category: 'flight', description: 'BSZ → ALA on Air Astana (Aug 8, 2 pax)', points: 24000, program: 'Turkish Miles&Smiles', note: 'Transfer 24K Turkish Miles&Smiles points. Air Astana, Bishkek to Almaty.' },
      // ─── Flights — Return ───
